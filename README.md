...
main에 push하면 전체 Markdown 글을 자동으로 빌드·배포합니다. 첫 화면은 최신순 글 목록이며, 글을 클릭하면 본문이 열립니다. 왼쪽 달력으로 날짜를 선택하고 제목·본문·날짜로 검색할 수 있고, `/#2026-09-13`처럼 링크를 공유할 수 있습니다. 제목·문단·목록·인용·링크·코드 등 Markdown을 지원합니다.
